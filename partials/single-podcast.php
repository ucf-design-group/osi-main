 ...
 */
	...
	$audio_file = $GLOBALS['wpdb']->get_var("SELECT guid FROM $wpdb->posts WHERE post_parent = '$post->ID' AND post_type='attachment'");
	...
	<div class="podcast-content-wrapper">
		<div class="podcast-header-wrapper">
			...
			<div class="podcast-title-info">
				...
				<h4><?php echo get_the_title(); echo $audio_id; ?></h3>
			</div>
		</div>
